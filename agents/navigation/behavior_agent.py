...
class BehaviorAgent(Agent):
    ...
    def __init__(self, vehicle, sampling_res=1.0 ,ignore_traffic_light=True, behavior='normal'):
        """
        Constructor method.
        ...
        # self._sampling_resolution = 0.01
    ...
    def collision_and_car_avoid_manager(self, location, waypoint):
        ...
        if self.direction == RoadOption.CHANGELANELEFT:
            ...
            if vehicle_state and (self.direction == RoadOption.LANEFOLLOW or self.direction == RoadOption.STRAIGHT) and \
            ...
            elif not vehicle_state and (self.direction == RoadOption.LANEFOLLOW or self.direction == RoadOption.STRAIGHT) \
